...
import { applyStudentFormChange } from '@/lib/studentForm'
...
export function StudentForm({
  ...
  const patch = (updates) => onChange(applyStudentFormChange(form, updates))
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <FormField id="educationLevel" label="Education level" error={errors.educationLevel}>
          <Select
        ...
        <FormField id="gradeYear" label="Grade year" error={errors.gradeYear}>
          <Select
